    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Siddu/Desktop/Attendance Management System/Attendance Management System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Siddu\Desktop\Attendance Management System\Attendance Management System\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Siddu/Desktop/Attendance Management System/Attendance Management System/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Siddu\Desktop\Attendance Management System\Attendance Management System\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'vithal':
            if password == 'vithal123':
                ...
                cs = 'C:\Users\Siddu\Desktop\Attendance Management System\Attendance Management System\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
